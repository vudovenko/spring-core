package vudovenko.dev.patterns.pollQuestion.statistic.analyzer.impl;
...
public class PollAnalyzerImpl implements PollAnalyzer {

    private AnalyzeStrategy strategy;

    public PollAnalyzerImpl(AnalyzeStrategy strategy) {
